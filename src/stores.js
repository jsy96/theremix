...
let storedFTUE = true
let storedPoseFTUE = false
let storedAllowHolistic = false // force posenet - mediapipe holistic v0.1 model files no longer available
...
export const getLocalStorage = ()=>{
  if (typeof Storage !== "undefined") {
    ...
    storedPoseFTUE = false;
    storedAllowHolistic = false;
    storedShowVideo = 
